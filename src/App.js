...
class App extends React.Component {
  ...
  openCartBoxHandler = () => {
    this.setState((prevState) => {
      return ({ cartButton: !prevState.cartButton, popupType: 'cart' })
    });
  }
  ...
  productPageHandler = item => {
    this.setState({ cartButton: true, popupType: 'product', selectedItem: item });

  }

  popupTypeHandler = () => {
    const { popupType, selectedItem } = this.state;
    let returnType;
    switch (popupType) {
      case 'cart': {
        returnType = (
          <Cart
            ...
            clicked={this.state.cartButton}
            cartItem={this.state.itemsInCart}
            click2={(props) => {
  ...
  render() {
    ...
    const items = this.state.tempItemArray.map((x, index) =>
      <IndividualItem
        wholeItem={x}
        itemSetter={this.itemSetter}
        heartSelected={x.heartSelected}
        productPageHandler={this.productPageHandler}
        heartChangeHandler={this.heartChangeHandler}
        gallerySetter={this.gallerySetter}
        display={x.display}
        id={x.id}
        item={x.img}
        name={x.name}
    ...
    return (
      <div>
        {cartButton ? this.popupTypeHandler() : null}
        <header class="headerStyle">
          <div class="rightComponent">
            ...
            <div class="iconHolder">
              <img style={{ width: 25, height: 25 }} src={User} alt="unloaded" />
              <p style={{ color: 'white', fontSize: 10, marginTop: 3 }}>LOGIN</p>
            </div>
        ...
        <div class="main">
          ...
          <div class="bodyHolder">
            <div class="left">
              ...
              <div class="sort-container">{sortButtons}</div>
            </div>
            <div class="right">
              {items}
            </div>
